...
class Company: CompanyCreator { // Protocol ✅
    ...
    private var employees: [Employee]?  // Optional ✅
...
let employee1       = Employee(name: "Esat", age: 28, maritalSatatus: .married, title: .junior, employeeId: 1)
...
secondCompany.hireEmployee(name: "Esat", age: 28, maritalStatus: .married, title: .junior, employeeId: 1)
